...
function FullLayout({
  ...
  return (
    <div className="quiz-card relative w-full max-w-[760px] rounded-[56px] px-6 pb-8 pt-10 md:px-10 md:pb-10 md:pt-12">
      <div className="mb-6 text-center">
        <h1
          className="animate-shimmer-text animate-text-reveal text-2xl font-black tracking-tight md:text-3xl"
          style={{ animationDelay: '0.1s' }}
        ...
        <p
          ...
          style={{ animationDelay: '0.3s' }}
        >
          Din Mentorkompass är en startpunkt. Välj ett nästa steg som känns mest intressant för dig.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          <p className="mb-4 text-sm leading-relaxed text-neutral-600">
            Det kan till exempel vara någon som jobbar som programmerare, jurist, ingenjör, ekonom,
            sjuksköterska, designer, polis, kommunikatör eller entreprenör.
          </p>
          <BulletList items={mentorshipBullets} label="Mentorskap kan hjälpa dig att förstå:" />
          <div className="mt-4">
            <QuizButton label="Jag är nyfiken på mentorskap" />
  ...
  return (
    <div className="quiz-card relative flex h-[720px] max-h-[calc(100vh-2rem)] w-full max-w-[760px] flex-col overflow-clip rounded-[56px] px-6 pb-8 pt-10 md:px-10 md:pb-10 md:pt-12">
      ...
      <div className="flex flex-1 flex-col gap-3 overflow-hidden">
        ...
        >
          <p className="mb-3 text-sm leading-relaxed text-neutral-600">
            SYV kan hjälpa dig att förstå vilka gymnasieprogram, kurser och utbildningsvägar som
            passar det du är intresserad av.
          </p>
          <BulletList items={syvBullets} label="Frågor du kan ta med till SYV:" />
          <div className="mt-4">
            <QuizButton label="Jag vill prata med SYV" />
        ...
        >
          ...
          <textarea
            ...
            onBlur={() => setFocusedField(false)}
            rows={2}
            className="w-full resize-none rounded-2xl border-2 border-neutral-200 bg-white/80 px-5 py-3 text-sm font-semibold text-neutral-800 shadow-sm outline-none backdrop-blur-sm transition-all duration-300 placeholder:text-neutral-400 focus:border-[var(--page-accent)] focus:shadow-[0_0_0_4px_var(--page-accent-glow)]"
          />
          <div className="mt-3">
            <QuizButton
              label={saved ? 'Sparat!' : 'Spara mitt nästa steg'}
...
export function FinalPage(props: FinalPageProps) {
  ...
  const layoutProps = {
    ...
    onNextStepChange: props.onNextStepChange,
  }

  return (
    <div className="flex w-full max-w-[760px] flex-col items-center">
      <div className="mb-4 flex gap-1 rounded-full border border-black/10 bg-white/60 p-1 backdrop-blur-sm">
        {(Object.keys(layoutLabels) as LayoutMode[]).map((mode) => (
          <button
            ...
            className={`cursor-pointer rounded-full px-4 py-1.5 text-xs font-bold transition-all duration-200 ${
              layoutMode === mode
                ? 'bg-[var(--page-accent)] text-white shadow-sm'
