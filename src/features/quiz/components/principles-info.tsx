...
export function PrinciplesInfo({
  ...
  return (
    <div className="quiz-card hover-lift flex h-[720px] max-h-[calc(100vh-2rem)] w-full max-w-[760px] flex-col overflow-hidden rounded-[56px] px-6 pb-8 pt-8 md:px-10 md:pb-10 md:pt-10">
      <div className="mb-6">
